...
function App() {
  return (
    ...
    <h1 id="props">PROPS(class comp)</h1>
      <div class="greet"> 
        <div className='a3'><Greet name="Hi class prps" hobby="Youtube"/></div>
        <div className='a1'><Greet name="Hi properties" hobby="Reading Book"/></div>
        <div className='a2'> <Greet name="Hi friend" hobby="Coocking"/></div>
      </div>
      <div className='fun'>
